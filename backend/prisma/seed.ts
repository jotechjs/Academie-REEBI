        ...
        create: [
          {
            ...
            columns: {
              create: [
                ...
                { name: 'Observation', dataType: SessionColumnDataType.TEXT, position: 7 },
                { name: 'Code Attestation', dataType: SessionColumnDataType.TEXT, position: 8 },
                { name: 'Moyenne Cours', dataType: SessionColumnDataType.NUMBER, position: 9 },
                { name: 'Admis pour évaluation', dataType: SessionColumnDataType.TEXT, position: 10 },
                { name: 'Evaluation Ecrite', dataType: SessionColumnDataType.NUMBER, position: 11 },
                { name: 'Evaluation Orale', dataType: SessionColumnDataType.NUMBER, position: 12 },
                { name: 'Préseance au cours', dataType: SessionColumnDataType.NUMBER, position: 13 },
                { name: 'Compte rendu', dataType: SessionColumnDataType.NUMBER, position: 14 },
              ],
            },
          },
          {
